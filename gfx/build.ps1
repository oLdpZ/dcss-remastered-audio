...
# postprocess.c / iat_hook.c / shmem.c aggiunti in Task 2/4
cmd /c "`"$vc`" x86 && cl /nologo /LD /O2 `"$here\gl_proxy.c`" /Fe:`"$here\opengl32.dll`" /link /MACHINE:X86 gdi32.lib user32.lib"
